...
import type { UserMeta } from './user-side-toggle'
import {
  Box,
  Check,
  ChevronDown,
...
import { ModeToggleGradientIcon as ModeToggle } from '@/components/common/theme-toggle'
...
import { Button as UIButton } from '@heroui/button'
        ...
        <SidebarMenu className="flex-row">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <ModeToggle className="size-10 active:bg-sidebar-accent" />
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarFooter>
